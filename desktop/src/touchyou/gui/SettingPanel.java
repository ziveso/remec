...
public class SettingPanel extends JPanel {
	...
	public SettingPanel(App app, JFrame mainframe) {
		...
		rdbtnUsePreferIcon = new JRadioButton("Use Prefer Icon");
		rdbtnUsePreferIcon.setForeground(GuiUtil.getForegroundColor());
		...
		iconGroup.add(rdbtnUsePreferIcon);
		...
		rdbtnUsePreferIcon.addActionListener(e -> {
			iconpath.setEnabled(false);
			btnBrowse.setEnabled(false);
			btnCapture.setEnabled(false);
